...
const Card = (props) => {
  return ( <>
    ...
    height={90}
      ...
      />
      <h2 className='text-lg md:text-lg my-2 text-amber-400 '>{props.title}</h2>
      <div className='text-lg font-bold  md:lg my-2 text-white'>Rs {props.priceS} S ,{props.priceM} M ,{props.priceL} L </div>
   </div>
  </> )
}
